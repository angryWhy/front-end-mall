    ...
    <div>
        ...
        <el-form :model="form" label-width="120px" v-loading="loading2" :rules="rules" ref="formRef">
            ...
            <el-form-item label="是否需要检索">
                <el-select v-model.number="form.searchType" class="m-2" style="width:100%;">
            ...
            <el-form-item label="属性类型">
                <el-select v-model.number="form.attrType" class="m-2" style="width:100%;">
            ...
            <el-form-item label="启用状态">
                <el-select v-model.number="form.enable" class="m-2" style="width:100%;">
            ...
            <el-form-item label="快速展示">
                <el-select v-model.number="form.showDesc" class="m-2" style="width:100%;">
...
export default {
    ...
    setup(props) {
        ...
        if (props.currentRow != null) {
            form.value.attrName = props.currentRow.attrName,
            form.value.searchType = String(props.currentRow.searchType),
            form.value.icon = props.currentRow.icon,
            form.value.valueSelect = props.currentRow.valueSelect,
            form.value.attrType = String(props.currentRow.attrType),
            form.value.enable = String(props.currentRow.enable),
            form.value.attrGroupId  = String(props.currentRow.attrGroupId),
            form.value.catelogId = props.currentRow.catelogId,
            form.value.showDesc =  String(props.currentRow.showDesc),
            form.value.attrId = props.currentRow.attrId
        }
